...
# Backend <Badge text="easy" type="info" />
...
>
  ``` ln-history-api | info: Microsoft.Hosting.Lifetime[14] ln-history-api | Now
  listening on: http://[::]:8080 ln-history-api | info:
  Microsoft.Hosting.Lifetime[0] ln-history-api | Application started. Press
  Ctrl+C to shut down. ln-history-api | info: Microsoft.Hosting.Lifetime[0]
  ln-history-api | Hosting environment: Production ln-history-api | info:
  Microsoft.Hosting.Lifetime[0] ln-history-api | Content root path: /app ```
</Terminal>
