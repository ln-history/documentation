...
The term `valid` means that the information of the _valid_ gossip message can be found in the topology of the Lightning Network.
...
Gets all `node_announcement` messages for a given `node_id`.
...
Throught this project I have used the term `the (Bitcoin) Lightning Network`. To be very exact this is confusing. There is not *`the`* Lightning Network, technically multiple Lightning Networks could exists in parallel.
