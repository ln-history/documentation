...
_The simpler mode is the **bulk-import**, which I recommend for starters_.
...
2. Install the (latest) Docker packages
   ...
   <TerminalOneLiner command="sudo apt-get install docker-ce docker-ce-cli containerd.io docker-buildx-plugin docker-compose-plugin" />
