...
## Test Connection Without Installing PostgreSQL

We test if the database has been sucessfully created without having to installed `psql` on the machine by just running this Docker command:
